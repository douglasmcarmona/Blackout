...
public:
	...
	/**
	 * Increases the BatteryPercentage propertyu in the implementing class. Allows the battery actor to charge the flashlight's
	 * battery
	 * @param Percent The amount of additional charge the flashlight will receive
	 */
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, meta=(ForceAsFunction), Category="Flashlight")
	void AddBatteryPercentage(const float Percent);
};
